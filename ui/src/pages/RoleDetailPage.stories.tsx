...
const meta = { component: RoleDetailPage, title: "Pages/Access/Role Detail" } satisfies Meta<typeof RoleDetailPage>;
export default meta;
type Story = StoryObj<typeof meta>;
export const Custom: Story = { args: { model } };
export const BuiltIn: Story = { args: { model: previewRoleDetail("tenant-viewer") ?? model } };
