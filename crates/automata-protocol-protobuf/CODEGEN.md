...
```console
crates/automata-protocol-protobuf/tools/protobuf-codegen.sh verify
```
...
```console
crates/automata-protocol-protobuf/tools/protobuf-codegen.sh regenerate
```
