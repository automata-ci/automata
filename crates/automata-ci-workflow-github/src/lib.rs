...
pub use model::{
    ...
    GithubEventMetadataV1, GithubWorkflow, GithubWorkflowDispatchContract,
    ...
    MatrixMapping, MatrixValue, MatrixValueEntry, Needs, PermissionEntry, PermissionLevel,
    Permissions, PreservedField, PushPullRequestFilter, ReusableWorkflowCall,
