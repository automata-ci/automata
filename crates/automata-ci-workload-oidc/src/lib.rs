#![forbid(unsafe_code)]
#![deny(missing_docs)]
//! Provider-neutral Automata workload OIDC protocol.
//!
...
/// Stable namespace for an optional Automata workload OIDC runtime-authority contribution.
///
/// This crate defines the identifier only; runner-control and environment
/// composition remain separate integration boundaries.
pub const WORKLOAD_OIDC_RUNTIME_AUTHORITY_NAMESPACE: &str = "workload-oidc";
...
pub use http::{
    OIDC_DISCOVERY_PATH, OIDC_JWKS_CACHE_SECONDS, OIDC_JWKS_PATH, OIDC_TOKEN_PATH,
    OIDC_TOKEN_REQUEST_PATH_AND_QUERY, OidcClock, OidcClockError, WorkloadOidcApi,
};
pub use keys::{
