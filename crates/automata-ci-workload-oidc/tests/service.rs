...
use automata_ci_workload_oidc::{
    AuthorizedOidcIssuance, InMemoryOidcRepository, InMemoryOidcRepositoryLimits, OidcAudience,
    OidcClock, OidcClockError, OidcIdToken, OidcIssuance, OidcIssuanceRepository,
...
fn service_and_api_debug_do_not_delegate_to_injected_boundaries() {
    ...
    let api = WorkloadOidcApi::new(service, Arc::new(SentinelClock));
