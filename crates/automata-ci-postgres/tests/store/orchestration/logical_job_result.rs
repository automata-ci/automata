...
use automata_ci_store::{
    ...
    LogicalInstanceResultClaimOutcome, LogicalInstanceResultRepository as _,
    LogicalInstanceResultTarget, LogicalInstanceResultWorkerId,
    LogicalJobOrchestrationSelectionOutcome, LogicalJobResultClaimNextOutcome,
    LogicalJobResultClaimOutcome, LogicalJobResultRepository as _, LogicalJobResultSelectionId,
    ...
    let accepted = database
        ...
        .accept_manifest_pinned_github_delivery(AcceptManifestPinnedGithubDelivery::new(
            AcceptProviderDelivery::new(
                ...
                crate::support::provider_delivery_event_envelope(0x85),
