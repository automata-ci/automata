...
pub fn decode(
    ...
    automata_ci_action_github::GithubActionMetadata,
    automata_ci_action_github::MetadataDecodeError,
> {
    use automata_ci_action_github::ActionMetadataDecoder as _;
    automata_ci_action_github::GithubActionMetadataDecoder::default()
