...
impl StateRoot {
    ...
    /// Returns the validated absolute state-root path.
    ///
    /// File operations still use the adapter's securely opened directory
    /// descriptor; this value is informational and is not a reopened trust
    /// boundary.
    #[must_use]
