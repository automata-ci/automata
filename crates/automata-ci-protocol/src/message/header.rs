...
impl MessageHeader {
    ...
    #[must_use]
    /// Returns the message-structure schema carried by the envelope.
    ...
    #[must_use]
    /// Returns the stable idempotency identity of this operation.
    pub const fn operation_id(self) -> OperationId {
        self.operation_id
    }

    #[must_use]
    /// Returns the request operation answered by this message, if any.
