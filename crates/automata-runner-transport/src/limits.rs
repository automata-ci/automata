...
impl TransportLimits {
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if either limit is zero.
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if a duration is zero.
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if a duration is zero or the long-poll
    /// deadline is shorter than the ordinary handler deadline.
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if a duration is zero or either component
    /// deadline exceeds the total request deadline.
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if either duration is zero.
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if the duration is zero.
    ...
    /// # Errors
    ///
    /// Returns [`ConfigurationError`] if the duration is zero or shorter than
    /// the configured long-poll deadline.
