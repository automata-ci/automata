use automata_ci_ui_renderer::{MAX_RENDER_REQUEST_UTF8_BYTES, MAX_RENDERED_HTML_UTF8_BYTES};
use serde_json::Value;

#[test]
fn generated_rust_limits_match_the_canonical_ui_contract() {
    let contract: Value = serde_json::from_str(include_str!("../contract.json"))
