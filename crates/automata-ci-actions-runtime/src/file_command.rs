...
pub struct ActionsCommandFileDecoder {
    limits: CommandFileLimits,
}

impl ActionsCommandFileDecoder {
...
impl Default for ActionsCommandFileDecoder {
    fn default() -> Self {
        Self::new(CommandFileLimits::default())
    }
}

impl CommandFileDecoder for ActionsCommandFileDecoder {
    fn decode(
        &self,
        kind: CommandFileKind,
        source: &[u8],
