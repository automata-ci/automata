...
pub struct ActionsWorkflowCommandSession {
...
impl ActionsWorkflowCommandSession {
...
impl Default for ActionsWorkflowCommandSession {
    fn default() -> Self {
        Self::new(
...
impl fmt::Debug for ActionsWorkflowCommandSession {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        formatter
            .debug_struct("ActionsWorkflowCommandSession")
...
impl WorkflowCommandProcessor for ActionsWorkflowCommandSession {
    fn process_line(&mut self, source: &[u8]) -> Result<WorkflowLine, WorkflowCommandError> {
