...
use automata_runner_runtime::{
    ...
    RunnerRuntimeLimits, RuntimeIdSource, StableIdDomain, SystemRuntimeIds,
};
...
assert_obj_safe!(automata_runner_runtime::RunnerRuntimeControlClient);
assert_obj_safe!(automata_runner_runtime::JobExecutor);
assert_obj_safe!(automata_runner_runtime::RuntimeClock);
assert_obj_safe!(automata_runner_runtime::RuntimeSleeper);
assert_obj_safe!(automata_runner_runtime::RuntimeIdSource);
assert_obj_safe!(automata_runner_runtime::ExecutionEvents);
