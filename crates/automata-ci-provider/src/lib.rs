...
pub use credential::{
    ...
    WorkloadCredentialIndeterminateReason, WorkloadCredentialIssueFuture,
    WorkloadCredentialIssueOutcome, WorkloadCredentialPermission, WorkloadCredentialPermissionSet,
