...
pub use credential::{
    ...
    ProviderCredentialGeneration, ProviderCredentialModelError,
    WorkloadCredentialIndeterminateReason, WorkloadCredentialIssuance,
    WorkloadCredentialIssueFuture, WorkloadCredentialIssueOutcome, WorkloadCredentialPermission,
    WorkloadCredentialPermissionSet, WorkloadCredentialProvider, WorkloadCredentialProviderError,
    WorkloadCredentialProviderErrorKind, WorkloadCredentialRequest, WorkloadCredentialRetirement,
    WorkloadCredentialRetryAfter, WorkloadCredentialRevocationCandidate,
