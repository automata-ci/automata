...
CREATE TABLE github_check_subjects (
    ...
    CONSTRAINT github_check_subjects_schedule_fire_non_nil CHECK (((schedule_fire_id IS NULL) OR (schedule_fire_id <> '00000000-0000-0000-0000-000000000000'::uuid))),
    CONSTRAINT github_check_subjects_sha CHECK (((octet_length(head_sha) = ANY (ARRAY[20, 32])) AND (head_sha <> decode(repeat('00'::text, octet_length(head_sha)), 'hex'::text)))),
