...
pub fn decode(
    ...
    automata_ci_action_actions::GithubActionMetadata,
    automata_ci_action_actions::MetadataDecodeError,
> {
    use automata_ci_action_actions::ActionMetadataDecoder as _;
    automata_ci_action_actions::GithubActionMetadataDecoder::default()
