...
use automata_ci_store::{
    ...
    GITHUB_AUTHORITY_EXPIRY_SKEW_MILLIS, GithubInstallationId, GithubRepositoryId,
    ...
    ProtectedGithubRuntimeAuthority, ReadyGithubRuntimeAuthority, RepositoryId,
...
impl IdentityInputs {
    ...
    fn try_build(self) -> Result<GithubRuntimeAuthorityIdentity, GithubRuntimeAuthorityValueError> {
        GithubRuntimeAuthorityIdentity::new(
            ...
            GithubInstallationId::new(self.provider_installation_id)
...
#[test]
fn repository_and_namespace_shapes_are_canonical() {
    assert_eq!(
