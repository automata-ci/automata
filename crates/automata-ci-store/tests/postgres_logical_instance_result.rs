...
use automata_ci_store::{
    ...
    LogicalInstanceResultRepository as _, LogicalInstanceResultSelectionId,
    LogicalInstanceResultStoreError, LogicalInstanceResultTarget, LogicalInstanceResultWorkerId,
