...
use automata_ci_store::{
    ...
    LogicalWorkflowJobKind, MAX_GITHUB_SCHEDULE_FIRE_ATTEMPTS, ObjectKey, PostgresStore,
    ProviderConnectionId, ProviderInstallationId, ProviderRepositoryId, ProviderRepositoryOwnerId,
