...
use automata_ci_store::{
    ...
    PostgresStore, QueuedAttempt, RequestCancellation, ResumeRunnerSession,
    RunnableAttemptRepository as _, RunnableScanLimit, RunnableScanRequest,
    RunnerClaimRepository as _, RunnerCommandOutbox as _, RunnerGeneration,
    ...
    RunnerRoutingRepository as _, RunnerSessionRepository as _, RunnerSlotAvailability,
    RunnerSlotAvailabilityRepository as _, StableRunnerSlot, StoreError, TransitionAttempt,
    TryClaimAttempt, TryClaimOutcome, WORKFLOW_ADMISSION_EPOCH, WorkflowPlanRepository as _,
};
...
async fn insert_attempt(
    store: &automata_ci_store::PostgresStore,
    job_id: JobId,
    attempt_number: u32,
    queued_at: i64,
