...
/// Maximum provider changed-file records exposed by the upstream REST transport.
///
/// github.com Actions selection is separately fixed to its first 300 records;
/// this durable 3,000-record transport ceiling is retained for manifest replay.
