...
use super::{
    ...
    environment_review::execute_environment_review_command, priority::execute_priority_command,
    rerun::execute_rerun_command, runner::execute_runner_command, secret::execute_secret_command,
};
...
pub async fn execute_control_plane_command(
    ...
    match command {
        ...
        Command::Priority(args) => execute_priority_command(server_url, output, args).await,
        Command::Runner(args) => execute_runner_command(server_url, output, args).await,
        Command::Server(_) | Command::Local(_) | Command::Internal(_) => {
