...
use automata_ci_core::{RUNNER_REQUIREMENTS_SCHEMA_VERSION, RunnerRequirements};
use thiserror::Error;
...
pub enum RoutingRequirementsError {
    ...
    UnsupportedSchema {
        /// Requirement schema version understood by this build.
        supported: u16,
        /// Requirement schema version supplied by the planner.
        received: u16,
    },
}
