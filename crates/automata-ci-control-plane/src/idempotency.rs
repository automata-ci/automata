...
pub enum OperationRequestDigestError {
    ...
    InvalidLength {
        /// Required byte length of the canonical hexadecimal representation.
        expected: usize,
        /// Byte length of the rejected representation.
        received: usize,
    },
    ...
    InvalidHexCharacter {
        /// Zero-based byte offset of the rejected character.
        index: usize,
    },
}
