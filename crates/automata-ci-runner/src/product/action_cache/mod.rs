...
#[cfg(unix)]
pub use archive_cache::{ActionArchiveCacheLimits, ActionArchiveCacheRoot, FileActionArchiveCache};
...
impl ActionReferenceIndexLimits {
    ...
    /// Returns the retained reference count ceiling.
    #[must_use]
    pub const fn maximum_entries(self) -> usize {
        self.maximum_entries
    }

    /// Returns the canonical encoded-document byte ceiling.
    #[must_use]
