...
impl LocalDockerProductConfig {
    /// Returns the configured installation binding resolved during provider connection.
    #[must_use]
    pub const fn installation_binding(&self) -> &automata_ci_local::InstallationBinding {
