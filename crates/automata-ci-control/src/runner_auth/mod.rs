...
//!
//! [`MachineAuthenticationEvidence`](automata_ci_auth::machine::MachineAuthenticationEvidence)
//! must come directly from `automata-ci-runner-transport` after rustls has successfully
...
//!
//! This module deliberately does not parse X.509 or repeat chain validation. It bounds
