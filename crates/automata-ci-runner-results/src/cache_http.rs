...
pub struct ActionsCacheHttpLimits {
    maximum_twirp_body_bytes: usize,
    maximum_azure_body_bytes: usize,
}

impl ActionsCacheHttpLimits {
    ...
    pub const fn new(
        maximum_twirp_body_bytes: usize,
        maximum_azure_body_bytes: usize,
    ) -> Result<Self, ActionsCacheHttpLimitsError> {
        ...
        {
            return Err(ActionsCacheHttpLimitsError);
        }
        Ok(Self {
...
impl Default for ActionsCacheHttpLimits {
    fn default() -> Self {
        Self {
...
pub struct ActionsCacheHttpLimitsError;
