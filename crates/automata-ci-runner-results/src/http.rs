...
pub struct ActionsResultsHttpLimits {
    maximum_twirp_body_bytes: usize,
    maximum_azure_body_bytes: usize,
}

impl ActionsResultsHttpLimits {
    ...
    pub const fn new(
        maximum_twirp_body_bytes: usize,
        maximum_azure_body_bytes: usize,
    ) -> Result<Self, ActionsResultsHttpLimitsError> {
        ...
        {
            return Err(ActionsResultsHttpLimitsError);
        }
        Ok(Self {
...
impl Default for ActionsResultsHttpLimits {
    fn default() -> Self {
        Self {
...
pub struct ActionsResultsHttpLimitsError;
...
#[derive(Clone, Debug)]
pub struct ActionsResultsApi {
    state: ApiState,
    limits: ActionsResultsHttpLimits,
}

impl ActionsResultsApi {
