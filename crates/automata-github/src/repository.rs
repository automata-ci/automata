use automata_auth::{github::GithubEndpointError, secret::SecretString};
use automata_scm::{
    ArchiveFormat, RepositorySnapshot, ResolvedRevision, ScmError, ScmErrorKind, ScmProvider,
...
impl GithubHttpEndpoint {
    fn repository_url(
        &self,
        repository: &automata_scm::RepositoryId,
        tail: &[&str],
    ) -> Result<Url, ScmError> {
