#![forbid(unsafe_code)]
#![deny(missing_docs)]
//! Current GitHub job-permission to workload-OIDC runtime-authority bridge.
//!
...
pub use runtime_authority::{
    ...
    GithubOidcRuntimeAuthorityIssuer, GithubOidcRuntimeAuthorityIssuerConfigurationError,
