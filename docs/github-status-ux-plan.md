...
- `crates/automata-ci-store/src/github_checks.rs` and
  `crates/automata-ci-store-postgres/src/github_checks.rs` persist fenced Check subjects and a durable,
...
- `crates/automata-ci-store-postgres/src/github_checks.rs`
- `crates/automata-ci-store-postgres/migrations/0001_initial_schema.sql`
